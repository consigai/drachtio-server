...
class EcrRepositoryStack(cdk.Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        repository = ecr.Repository(self,
                       "ConsigDrachtioServerRepo",
                       repository_name="consig-drachtio-server")

        drachtio_image_asset = ecr_assets.DockerImageAsset(self, "drachtioServer",
        ...
        ecrdeploy.ECRDeployment(self, f"DeployDockerImageSHA_{github_sha}",
                      src=ecrdeploy.DockerImageName(drachtio_image_asset.image_uri),
...
# Create Docker Repo
#
EcrRepositoryStack(app, "drachtioServer")
